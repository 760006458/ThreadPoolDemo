...
public class ThreadPoolExecutorTest1 extends Thread {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("init ActiveCount:" + executor.getActiveCount());
        System.out.println("init PoolSize:" + executor.getPoolSize());
        for (int i = 0; i < 10; i++) {  //丢掉1个任务
            executor.execute(new ThreadPoolExecutorTest1());
        }
        System.out.println("final ActiveCount:" + executor.getActiveCount());
        System.out.println("final PoolSize:" + executor.getPoolSize());
        executor.shutdown();
    }
}
